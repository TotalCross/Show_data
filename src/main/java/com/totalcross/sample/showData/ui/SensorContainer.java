...
public class SensorContainer extends Container {
        ...
        public void initUI() {
                ...
                Sensors.transparentBackground = true; // set background transparent
                ...
                boxi.transparentBackground = true;
                ...
                boxv.transparentBackground = true;
                ...
                boxa.transparentBackground = true;
                ...
                sc.add(box, SAME, AFTER + MaterialConstants.BORDER_SPACING, FILL, MaterialConstants.EDIT_HEIGHT);
                ...
                sc.add(box, SAME, AFTER + MaterialConstants.COMPONENT_SPACING, FILL, MaterialConstants.EDIT_HEIGHT);
