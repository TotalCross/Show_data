...
public class Fonts {
	...
	static {
		...
		// Lato Regular
		latoRegularDefaultSize = Font.getFont("SFDisplay-Regular", false, FONT_DEFAULT_SIZE);
		latoRegularMinus5 = latoRegularDefaultSize.adjustedBy(-5);
		title = Font.getFont("SFDisplay-Bold", false, 28);

		// Lato Medium
		latoMediumDefaultSize = Font.getFont("SFDisplay-Medium", false, FONT_DEFAULT_SIZE);
		...
		// Lato Bold
		latoBoldDefaultSize = Font.getFont("SFDisplay-Bold", false, FONT_DEFAULT_SIZE);
		...
		// Lato Light
		latoLightDefaultSize = Font.getFont("SFDisplay-Light", false, FONT_DEFAULT_SIZE);
